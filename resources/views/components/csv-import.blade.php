                ...
                <form action="{{ $attributes['route'] }}" method="POST" enctype="multipart/form-data">
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            <div class="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-slate-200 sm:mx-0 sm:h-10 sm:w-10">
                                <i class="fas fa-file-csv fa-fw text-slate-700 fa-lg"></i>
                            </div>
